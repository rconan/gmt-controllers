...
/* Model step function */
void m1hp_cpp_step(RT_MODEL_m1hp_cpp_T *const m1hp_cpp_M, ExtU_m1hp_cpp_T *m1hp_cpp_U, ExtY_m1hp_cpp_T *m1hp_cpp_Y)
{
  ...
  if (rtb_Compare && (m1hp_cpp_PrevZCX->TriggeredSubsystem_Trig_ZCE != POS_ZCSIG))
  {
    ...
    for (ForEach_itr = 0; ForEach_itr < 6; ForEach_itr++)
    {
      ...
      rtb_Gain2_o_idx_2 = sqrt(rtb_Gain2_o_idx_0 * rtb_Gain2_o_idx_0 * 0.5 +
                               rtb_Merge_idx_0 * rtb_Gain1_m) *
                          fabs(1.0 / rtb_Gain1_m);
      ...
      if (fabs(rtb_Gain1_m * t_a + m1hp_cpp_DW->TmpLatchAtTriggeredSubsystemI_e[ForEach_itr]) > fabs(v_l))
      {
        t_a = 1.0 / rtb_Gain1_m * (v_l - m1hp_cpp_DW->TmpLatchAtTriggeredSubsystemI_e[ForEach_itr]);
    ...
    for (i = 0; i < 6; i++)
    {
      ...
      for (i_0 = 0; i_0 < 6; i_0++)
      {
        ...
        m1hp_cpp_DW->Compare[i_0] = ((int32_T)
                                             rtb_ImpAsg_InsertedFor_t_a_d_at[i_0] -
                                         (int32_T)rtb_Add_p ==
                                     0);
      }
  ...
  for (ForEach_itr_p = 0; ForEach_itr_p < 6; ForEach_itr_p++)
  {
    ...
    if (tmp && rtb_Compare)
    {
      ...
      rtb_Merge_idx_0 = ((0.5 * rtb_Gain2_o_idx_2 + rtb_Merge_idx_0) *
                             m1hp_cpp_DW->Sub[ForEach_itr_p] +
                         m1hp_cpp_DW->Add[ForEach_itr_p]) /
                        (rtb_Gain2_o_idx_0 * rtb_Gain1_m) * 2.0;
      rtb_Gain1_m = ((0.0 - m1hp_cpp_DW->Add[ForEach_itr_p]) - m1hp_cpp_DW->Sub[ForEach_itr_p] * rtb_Gain2_o_idx_0 * 0.5) /
    ...
    else
    {
       ...
       */
      rtb_Merge_idx_0 = m1hp_cpp_DW->ImpAsg_InsertedFor_a_l_at_inpor[ForEach_itr_p];
    ...
    if (m1hp_cpp_DW->ResettableDelay_DSTATE == 0U)
    {
       ...
       */
      m1hp_cpp_IfActionSubsystem4(&m1hp_cpp_DW->CoreSubsys_p[ForEach_itr_p].acc_merge);
    ...
    else if ((m1hp_cpp_DW->ResettableDelay_DSTATE > m1hp_cpp_DW->IndexVector2) && (m1hp_cpp_DW->ResettableDelay_DSTATE <=
    ...
    else if ((m1hp_cpp_DW->ResettableDelay_DSTATE > m1hp_cpp_DW->IndexVector1) && (m1hp_cpp_DW->ResettableDelay_DSTATE <=
  ...
  for (ForEach_itr_n = 0; ForEach_itr_n < 6; ForEach_itr_n++)
  {
     ...
     *  Store in Global RAM
     */
    rtb_Compare = ((m1hp_cpp_DW->ImpAsg_InsertedFor_multi_ax_acc[ForEach_itr_n] != m1hp_cpp_DW->CoreSubsys_pn[ForEach_itr_n].DelayInput1_DSTATE) || (m1hp_cpp_DW->ResettableDelay_DSTATE ==
                                                                                                                                                     0U));

    /* Outputs for Triggered SubSystem: '<S6>/Triggered Subsystem' incorporates:
     *  TriggerPort: '<S25>/Trigger'
     */
    if (rtb_Compare && (m1hp_cpp_PrevZCX->CoreSubsys_pn[ForEach_itr_n].TriggeredSubsystem_Trig_ZCE_c != POS_ZCSIG))
    {
    ...
    m1hp_cpp_PrevZCX->CoreSubsys_pn[ForEach_itr_n].TriggeredSubsystem_Trig_ZCE_c = rtb_Compare;
     ...
     */
    rtb_Gain1_m = (0.5 * m1hp_cpp_DW->ImpAsg_InsertedFor_multi_ax_acc[ForEach_itr_n] * (rtb_Gain1_m * rtb_Gain1_m) + rtb_Gain1_m * m1hp_cpp_DW->CoreSubsys_pn[ForEach_itr_n].v0_in) + m1hp_cpp_DW->CoreSubsys_pn[ForEach_itr_n].x0_in;
    ...
    rtb_ImpAsg_InsertedFor_vel_d_ve[ForEach_itr_n] = m1hp_cpp_DW->CoreSubsys_pn[ForEach_itr_n].DiscreteTimeIntegrator;
  }
  ...
  for (ForEach_itr_o = 0; ForEach_itr_o < 6; ForEach_itr_o++)
  {
    ...
    /* DiscreteStateSpace: '<S9>/Bessel filter Acc' */
    {
      rtb_acc_f_vec_CoreSubsysCanOut = (0.03244777426700398) *
                                       ...
                                       (-0.041870031249146511) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[1] + (-0.028713548427511344) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[2] + (0.011133012176218511) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[3];
    ...
    /* DiscreteStateSpace: '<S9>/Bessel filter Pos' */
    {
      rtb_pos_f_vec_CoreSubsysCanOut = (0.03244777426700398) *
                                       ...
                                       (-0.041870031249146511) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[1] + (-0.028713548427511344) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[2] + (0.011133012176218511) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[3];
    ...
    /* DiscreteStateSpace: '<S9>/Bessel filter Vel' */
    {
      rtb_vel_f_vec_CoreSubsysCanOut = (0.03244777426700398) *
                                       ...
                                       (-0.041870031249146511) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[1] + (-0.028713548427511344) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[2] + (0.011133012176218511) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[3];
    ...
    {
      real_T xnew[4];
      xnew[0] = (0.99929981431203641) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[0] + (0.0031042747865349662) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[1] + (0.0011272265388925784) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[2] + (-0.00048171513831302137) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[3];
      xnew[0] += (0.032447774267003127) * rtb_ImpSel_InsertedFor_acc_vec_;
      xnew[1] = (-0.0031042747865343) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[0] + (0.99721849747464386) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[1] + (-0.0048617293379392135) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[2] + (0.0014442780771489749) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[3];
      xnew[1] += (0.041870031249145408) * rtb_ImpSel_InsertedFor_acc_vec_;
      xnew[2] = (0.0011272265388921621) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[0] + (0.0048617293379379367) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[1] + (0.99393549261937664) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[2] + (0.0051618924477805084) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[3];
      xnew[2] += (-0.028713548427510987) * rtb_ImpSel_InsertedFor_acc_vec_;
      xnew[3] = (0.00048171513831271606) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[0] + (0.0014442780771486141) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[1] + (-0.0051618924477798978) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[2] + (0.98956855323730686) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[3];
      xnew[3] += (-0.011133012176218924) * rtb_ImpSel_InsertedFor_acc_vec_;
      (void)memcpy(&m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterAcc_DSTATE[0], xnew,
                   sizeof(real_T) * 4);
    }
    ...
    {
      real_T xnew[4];
      xnew[0] = (0.99929981431203641) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[0] + (0.0031042747865349662) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[1] + (0.0011272265388925784) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[2] + (-0.00048171513831302137) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[3];
      xnew[0] += (0.032447774267003127) * rtb_Add1_i;
      xnew[1] = (-0.0031042747865343) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[0] + (0.99721849747464386) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[1] + (-0.0048617293379392135) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[2] + (0.0014442780771489749) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[3];
      xnew[1] += (0.041870031249145408) * rtb_Add1_i;
      xnew[2] = (0.0011272265388921621) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[0] + (0.0048617293379379367) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[1] + (0.99393549261937664) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[2] + (0.0051618924477805084) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[3];
      xnew[2] += (-0.028713548427510987) * rtb_Add1_i;
      xnew[3] = (0.00048171513831271606) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[0] + (0.0014442780771486141) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[1] + (-0.0051618924477798978) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[2] + (0.98956855323730686) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[3];
      xnew[3] += (-0.011133012176218924) * rtb_Add1_i;
      (void)memcpy(&m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterPos_DSTATE[0], xnew,
                   sizeof(real_T) * 4);
    }
    ...
    {
      real_T xnew[4];
      xnew[0] = (0.99929981431203641) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[0] + (0.0031042747865349662) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[1] + (0.0011272265388925784) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[2] + (-0.00048171513831302137) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[3];
      xnew[0] += (0.032447774267003127) * rtb_Add2;
      xnew[1] = (-0.0031042747865343) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[0] + (0.99721849747464386) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[1] + (-0.0048617293379392135) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[2] + (0.0014442780771489749) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[3];
      xnew[1] += (0.041870031249145408) * rtb_Add2;
      xnew[2] = (0.0011272265388921621) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[0] + (0.0048617293379379367) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[1] + (0.99393549261937664) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[2] + (0.0051618924477805084) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[3];
      xnew[2] += (-0.028713548427510987) * rtb_Add2;
      xnew[3] = (0.00048171513831271606) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[0] + (0.0014442780771486141) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[1] + (-0.0051618924477798978) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[2] + (0.98956855323730686) * m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[3];
      xnew[3] += (-0.011133012176218924) * rtb_Add2;
      (void)memcpy(&m1hp_cpp_DW->CoreSubsys[ForEach_itr_o].BesselfilterVel_DSTATE[0], xnew,
                   sizeof(real_T) * 4);
    }
...
void m1hp_cpp_initialize(RT_MODEL_m1hp_cpp_T *const m1hp_cpp_M)
{
...

  {
    ...
    for (ForEach_itr_p = 0; ForEach_itr_p < 6; ForEach_itr_p++)
    {
      ...
      m1hp_cp_IfActionSubsystem4_Init(&m1hp_cpp_DW->CoreSubsys_p[ForEach_itr_p].acc_merge);
    ...
    for (ForEach_itr_n = 0; ForEach_itr_n < 6; ForEach_itr_n++)
    {
      m1hp_cpp_PrevZCX->CoreSubsys_pn[ForEach_itr_n].TriggeredSubsystem_Trig_ZCE_c = POS_ZCSIG;
    }
