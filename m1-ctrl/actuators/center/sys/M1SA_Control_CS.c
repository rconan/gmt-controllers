...
void M1SA_Control_CS_step(RT_MODEL_M1SA_Control_CS_T *const M1SA_Control_CS_M,
  real_T M1SA_Control_CS_U_LC_FxyzMxyz_CG[6], real_T
  M1SA_Control_CS_U_SA_offsetF_cmd[306], real_T M1SA_Control_CS_Y_Res_Act_F[306])
{
   ...
   */
  {
    ...
    rtb_Fxcontroller += 0.024370329855613257*M1SA_Control_CS_U_LC_FxyzMxyz_CG[0];
  }
   ...
   */
  {
    ...
    rtb_Fycontroller += 0.024370329855613257*M1SA_Control_CS_U_LC_FxyzMxyz_CG[1];
  }
   ...
   */
  {
    ...
    rtb_Fzcontroller += 0.026005628588130471*M1SA_Control_CS_U_LC_FxyzMxyz_CG[2];
  }
   ...
   */
  {
    ...
    rtb_Mxcontroller += 0.024170972941162164*M1SA_Control_CS_U_LC_FxyzMxyz_CG[3];
  }
   ...
   */
  {
    ...
    rtb_Mycontroller += 0.024170972941162164*M1SA_Control_CS_U_LC_FxyzMxyz_CG[4];
  }
   ...
   */
  {
    ...
    rtb_Mzcontroller += 0.022749965907501887*M1SA_Control_CS_U_LC_FxyzMxyz_CG[5];
  }
  ...
  for (i = 0; i < 306; i++) {
     ...
     *  Sum: '<S1>/Add'
     */
    denAccum = (rtb_CS_SA_dyn[i] + M1SA_Control_CS_U_SA_offsetF_cmd[i]) -
     ...
     *  Gain: '<S1>/CS_Kbal'
     */
    M1SA_Control_CS_Y_Res_Act_F[i] = rtb_CS_SA_dyn[i];
   ...
   */
  {
    ...
    xnew[0] += (0.0041005206649182965)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[0];
    ...
    xnew[1] += (-0.0018292791104672012)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[0];
    xnew[2] = (1.0)*M1SA_Control_CS_DW->Fxcontroller_DSTATE[2];
    xnew[2] += (0.039999999999999994)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[0];
   ...
   */
  {
    ...
    xnew[0] += (0.0041005206649182965)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[1];
    ...
    xnew[1] += (-0.0018292791104672012)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[1];
    xnew[2] = (1.0)*M1SA_Control_CS_DW->Fycontroller_DSTATE[2];
    xnew[2] += (0.039999999999999994)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[1];
   ...
   */
  {
    ...
    xnew[0] += (0.0051578505311074812)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[2];
    ...
    xnew[1] += (0.00017169440437669837)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[2];
    xnew[2] = (1.0)*M1SA_Control_CS_DW->Fzcontroller_DSTATE[2];
    xnew[2] += (0.039999999999999994)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[2];
   ...
   */
  {
    ...
    xnew[0] += (0.0001958178153803155)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[3];
    ...
    xnew[1] += (0.0044051041445438335)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[3];
    xnew[2] = (1.0)*M1SA_Control_CS_DW->Mxcontroller_DSTATE[2];
    xnew[2] += (0.039999999999999994)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[3];
   ...
   */
  {
    ...
    xnew[0] += (0.0001958178153803155)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[4];
    ...
    xnew[1] += (0.0044051041445438335)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[4];
    xnew[2] = (1.0)*M1SA_Control_CS_DW->Mycontroller_DSTATE[2];
    xnew[2] += (0.039999999999999994)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[4];
   ...
   */
  {
    ...
    xnew[0] += (-0.00035257232440118766)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[5];
    ...
    xnew[1] += (-0.004691124684434827)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[5];
    xnew[2] = (1.0)*M1SA_Control_CS_DW->Mzcontroller_DSTATE[2];
    xnew[2] += (0.039999999999999994)*M1SA_Control_CS_U_LC_FxyzMxyz_CG[5];
