  ...
  DW_AZDTLugreFrmode_Mount_Drv__T *localDW)
{
  ...
  if (rtu_Enable > 0.0) {
    ...
    *rty_Tfr = (rtp_sigma1 * localDW->Sum + rtp_sigma0 *
    ...
    localDW->DiscreteTimeIntegrator_DSTATE += 0.001 * localDW->Sum;
  }
  ...
  ExtY_Mount_Drv_FDR2023_T *Mount_Drv_FDR2023_Y)
{
  ...
  for (i = 0; i < 3; i++) {
     ...
     */
    DiscreteTransferFcn_tmp = rtb_Drv_Pos_avg[i] * 1000.0;
  ...
  DiscreteTransferFcn_tmp = (rtb_iIsSig01Active - -14.915494309189533 *
    Mount_Drv_FDR2023_DW->DiscreteTransferFcn_states) / 16.915494309189533;
  ...
  Mount_Drv_FDR2023_DW->DiscreteTimeIntegrator_DSTATE += 0.001 *
    rtb_iIsSig01Active;
  ...
  DiscreteTransferFcn_tmp = rt_roundd(Mount_Drv_FDR2023_DW->DRVdelay_DSTATE[i_1]
    / 24.4140625) * 24.4140625 - -0.33333333333333331 *
    Mount_Drv_FDR2023_DW->DRV_dyn_states[0];
  rtb_Sum1_o = 0.33333333333333331 * DiscreteTransferFcn_tmp +
    0.33333333333333331 * Mount_Drv_FDR2023_DW->DRV_dyn_states[0];
  ...
  rtb_Sum1_pw = rt_roundd(Mount_Drv_FDR2023_DW->DRVdelay_DSTATE[i_1 + 1] /
    12.20703125) * 12.20703125 - -0.33333333333333331 *
    Mount_Drv_FDR2023_DW->DRV_dyn_states[1];
  rtb_Sum1_e = 0.33333333333333331 * rtb_Sum1_pw + 0.33333333333333331 *
    Mount_Drv_FDR2023_DW->DRV_dyn_states[1];
  ...
  rtb_Sum1_cj = rt_roundd(Mount_Drv_FDR2023_DW->DRVdelay_DSTATE[i_1 + 2] /
    5.7330322265625) * 5.7330322265625 - -0.33333333333333331 *
    Mount_Drv_FDR2023_DW->DRV_dyn_states[2];
  rtb_Sum1_hs = 0.33333333333333331 * rtb_Sum1_cj + 0.33333333333333331 *
    Mount_Drv_FDR2023_DW->DRV_dyn_states[2];
  ...
  if (Mount_Drv_FDR2023_DW->CircBufIdx < 3U) {
